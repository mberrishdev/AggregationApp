...
using AggregationApp.Application.InfrastrucgtreOptions;
using AggregationApp.Persistence.DbContexts;
using AggregationApp.Persistence.Repository;
using AggregationApp.Persistence.UnitOfWork;
...
namespace AggregationApp.Persistence
{
    public static class DependencyInjection
    {
        public static IServiceCollection AddPersistence(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            {
                options.UseSqlServer(configuration.GetConnectionString("AggregationDB"));
            },
